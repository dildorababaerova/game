...
class Game1:
    ...
    def init_graphics(self): 
        ...
        original_bird_dead_images  = [
            pygame.image.load(f"images/chicken/got_hit/frame-{i}.png").convert_alpha()
            for i in [1, 2]
        ]
        
        self.bird_dead_imgs = [
            pygame.transform.rotozoom(x, 0, self.screen_h / 9600)
    ...
    def handle_game_logic(self):
        ...
        if self.bird_lift and self.bird_alive:
        ...
        # Tarkista  onko lintu pudonnut maahan. Skalattu (600-135)/600 = 0.78
